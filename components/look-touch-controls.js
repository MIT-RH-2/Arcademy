...
var checkHasPositionalTracking = AFRAME.utils.device.checkHeadsetConnected;
var vrDisplay;
...
AFRAME.registerComponent('look-touch-controls', {
    ...
    updateOrientation: function () {
        ...
        this.polyfillControls && this.polyfillControls.update();
